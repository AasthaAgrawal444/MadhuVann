       ...
       <div className="desktop">
            <div className="div">
                <div className="overlap-group">
                    ...
                    <div className="text-wrapper-2">The Holographic Experience</div>
                    <p className="p">
                    ...
                    {/* <img className="output" alt="Output" src="output-onlinepngtools-2.png" /> */}
                    {/* <img
                        className="environment-earth"
                        alt="Environment earth"
                        src="environment-earth-day-in-the-hands-holding-green-earth-on-bokeh-green-background-saving-1.png"
                    /> */}
                    ...
                    {/* <img
                        ...
                        src="gsu-wildlife-center-summer-programs-2021-1.png"
                    /> */}
                    {/* <img className="element" alt="Element" src="9cf68cdb-c1d7-4ed1-87e8-3c5ff4272254-4-1.png" /> */}
                </div>
                {/* <img className="picsart" alt="Picsart" src="picsart-23-09-15-02-25-00-592-8.png" />
                <img className="menu" alt="Menu" src="menu-1-2.png" />
                <img className="hamburger" alt="Hamburger" src="hamburger-3.png" /> */}
            </div>
        </div>
    </div>
  )
